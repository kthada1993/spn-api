  ...
  await query(
    `
      ...
      ON DUPLICATE KEY UPDATE
        ...
        current_position_months = VALUES(current_position_months),
        shift_work_years = VALUES(shift_work_years),
        shift_work_months = VALUES(shift_work_months),
        ...
        underlying_disease_type = VALUES(underlying_disease_type),
